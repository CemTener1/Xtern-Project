...
ggmap::register_google(key = "AIzaSyDHIO1erK12RxkK0qcCu-PNYF7YttFrmd4", write = TRUE)
...
for (i in 2:nrow(sat_plan)) {
  time <- google_distance(
    ...
    key = "AIzaSyDHIO1erK12RxkK0qcCu-PNYF7YttFrmd4",  # Replace with your actual API Key
    mode = "driving"
  )
  print(time$rows)
}
